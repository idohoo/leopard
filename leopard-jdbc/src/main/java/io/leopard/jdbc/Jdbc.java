...
public interface Jdbc {
	...
	<T> Paging<T> queryForPage(String sql, Class<T> elementType);

	<T> Paging<T> queryForPage(String sql, Class<T> elementType, int start, int size);

	<T> Paging<T> queryForPage(String sql, Class<T> elementType, Object... params);

	<T> Paging<T> queryForPage(String sql, Class<T> elementType, StatementParameter param);

	<T> Paging<T> queryForPage(String sql, Class<T> elementType, StatementParameter param, int start, int size);
}
